...
Rice is a C++ header-only library that makes it easy to create Ruby extensions. See the [About Rice](about-rice.md) page for details on the Rice features demonstrated in this project.
